...
export const encode = (rq: RuleGroupTypeAny) => Buffer.from(superjson.stringify(rq), 'utf-8')
export const decode = (bf: ReturnType<typeof encode>) => superjson.parse(bf.toString('utf-8'))
